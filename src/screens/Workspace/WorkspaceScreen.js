...
export default function WorkspaceScreen({ navigation, route }) {
  ...
  const renderConceptBrandingCard = () => (
    <View style={styles.card}>
      <TouchableOpacity
        style={styles.cardHeader}
        onPress={() => toggleCard('conceptBranding')}
      >
        <Text style={styles.cardTitle}>🎨 Concept Branding</Text>
        <Text style={styles.expandIcon}>
          {expandedCard === 'conceptBranding' ? '−' : '+'}
        </Text>
      </TouchableOpacity>
          ...
          {idea?.cards?.conceptBranding ? (
            <>
              <View style={styles.section}>
                ...
                <Text style={styles.sectionText}>{idea.cards.conceptBranding.name}</Text>
              </View>
              <View style={styles.section}>
                <Text style={styles.sectionTitle}>Slogan</Text>
                <Text style={styles.sectionText}>{idea.cards.conceptBranding.slogan}</Text>
              </View>
              <View style={styles.section}>
                <Text style={styles.sectionTitle}>Tag</Text>
                <Text style={styles.sectionText}>{idea.cards.conceptBranding.tag}</Text>
              </View>
              <TouchableOpacity style={styles.actionButton}>
                <Text style={styles.actionButtonText}>Regenerate</Text>
              </TouchableOpacity>
            ...
            <View style={styles.placeholderContainer}>
              <Text style={styles.placeholderText}>Branding concepts will be generated by AI</Text>
            </View>
          )}
        </View>
      )}
